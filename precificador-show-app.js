...
function textoEquipe_(valor) {
  ...
  const normalizado = normalizarPerfil(texto);
  if (normalizado.indexOf('evento fora de fortaleza') !== -1) return 'Evento fora de Fortaleza';
  if (normalizado.indexOf('passagem de som') !== -1) return 'Passagem de som';
  return texto;
}
